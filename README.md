...
一个基于 Qt Widgets 的嵌入式可视化面板，集中展示并控制多种传感器与执行器。界面采用浅色卡片式设计，适合直接运行在开发板的全屏环境中。
...
## 全新 UI 设计
- **浅色主题与清晰层级**：背景使用纯白基调，搭配轻量描边和多彩强调色，增强触控面板的可读性与信息区分度。界面在 `mainwindow.ui` 中定义，开箱即全屏显示。【F:mainwindow.ui†L1-L120】【F:mainwindow.cpp†L11-L63】
